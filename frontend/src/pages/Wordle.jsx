...
  const [guesses, setGuesses] = useState([]); // tamamlanan satırlar [{guess, result}]
...
  const [letterStates, setLetterStates] = useState({}); // klavye renkleri

  const MAX_GUESSES = 6;
  const WORD_LENGTH = 5;

  useEffect(() => {
    // Günlük kelime bilgisini al
...
      const { result, isWon, target } = res.data;
...
              className="mt-3 px-6 py-2 rounded-xl gradient-bg text-white text-sm font-semibold transition-all hover:scale-[1.02]">
